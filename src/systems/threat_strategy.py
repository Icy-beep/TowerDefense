...
class ShipLandingStrategy(ThreatStrategy):
    """Корпораты высаживаются с кораблей"""
    ...
    def _random_border_point(self, game_map) -> Coordinate:
        """Случайная точка на границе карты чуть отступая от самого края"""
...
class NestSpawnStrategy(ThreatStrategy):
    """Фауна спавнит одного врага по таймеру с ограничением на число живых врагов фракции"""
